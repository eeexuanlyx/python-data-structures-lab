...
home_town = {'city':'Taiwan', 'state':'Taipei' , 'population': '3 million'}

def hometown_info():
    # your code here
    
    home_town_messgage = f'I was born in {home_town['city']}, {home_town['state']} - population of {home_town['population']}'
    return home_town_messgage
...
def list_home_town_items():
    # your code here
    home_town_items = []
    for key, value in home_town.items(): home_town_items.append(f'{key} = {value}')
